...
4. Tenemos que construir la celda en el storyboard de main. Es mejor no insertar la celda directamente en la escena del table view, ya que no se podría reutilizar en otras escenas/storyboards.
5. self.tableView.reloadData() recarga los datos de la tabla. Esta función deberá llamarse cuando se hayan cargado los datos a través de la peticion http.
