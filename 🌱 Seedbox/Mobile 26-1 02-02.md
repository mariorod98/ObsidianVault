...
7. Añadimos una label y conectamos los constrains leading con la imagen y trailing con el fin de la celda
8. self.tableView.reloadData() recarga los datos de la tabla. Esta función deberá llamarse cuando se hayan cargado los datos a través de la peticion http.
